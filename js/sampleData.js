...
function createSoftwareRelease() {
  return {
    ...
    dashTasks: [
      ...
      { id: id('d'), name: 'Billing module — backend', assigned: 'Sam P.', start: '2026-10-02', end: '2026-10-10', baseStart: '2026-10-02', baseEnd: '2026-10-10', status: 'In Progress', prio: 'High', comments: 'On track for feature freeze.' },
      { id: id('d'), name: 'Billing module — UI', assigned: 'Priya D.', start: '2026-10-05', end: '2026-10-12', baseStart: '2026-10-05', baseEnd: '2026-10-12', status: 'In Progress', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'Security review', assigned: 'Jordan L.', start: '2026-10-08', end: '2026-10-14', baseStart: '2026-10-08', baseEnd: '2026-10-14', status: 'Not Started', prio: 'High', comments: 'Blocked on backend completion.' },
      { id: id('d'), name: 'DB migration scripts', assigned: 'Sam P.', start: '2026-10-06', end: '2026-10-12', baseStart: '2026-09-30', baseEnd: '2026-10-06', status: 'On Hold', prio: 'Medium', comments: 'Needs staging refresh first.' },
      { id: id('d'), name: 'Regression testing', assigned: 'Priya D.', start: '2026-10-15', end: '2026-10-22', baseStart: '2026-10-15', baseEnd: '2026-10-22', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Performance profiling', assigned: 'Alex R.', start: '2026-10-14', end: '2026-10-19', baseStart: '2026-10-09', baseEnd: '2026-10-14', status: 'Overdue', prio: 'Medium', comments: 'Needs a decision on target hardware.' },
      { id: id('d'), name: 'Release notes & docs', assigned: 'Jordan L.', start: '2026-10-24', end: '2026-10-27', baseStart: '2026-10-24', baseEnd: '2026-10-27', status: 'Not Started', prio: 'Low', comments: '' },
    ],
  };
}
...
function createEventPlanning() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Venue research & tours', assigned: 'Devon M.', start: '2026-11-01', end: '2026-11-05', baseStart: '2026-11-01', baseEnd: '2026-11-05', status: 'Complete', prio: 'High', comments: 'Went with the lakeside conference center.' },
      { id: id('d'), name: 'Catering vendor selection', assigned: 'Riya S.', start: '2026-11-05', end: '2026-11-08', baseStart: '2026-11-05', baseEnd: '2026-11-08', status: 'In Progress', prio: 'Medium', comments: 'Waiting on final headcount.' },
      { id: id('d'), name: 'AV & staging setup', assigned: 'Devon M.', start: '2026-11-06', end: '2026-11-10', baseStart: '2026-11-03', baseEnd: '2026-11-07', status: 'Not Started', prio: 'Medium', comments: 'Quote pending from vendor.' },
      { id: id('d'), name: 'Agenda & speaker lineup', assigned: 'Riya S.', start: '2026-11-03', end: '2026-11-10', baseStart: '2026-11-03', baseEnd: '2026-11-10', status: 'In Progress', prio: 'High', comments: '' },
      { id: id('d'), name: 'Invitations & RSVP tracking', assigned: 'Devon M.', start: '2026-11-10', end: '2026-11-18', baseStart: '2026-11-10', baseEnd: '2026-11-18', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Swag & name badges', assigned: 'Riya S.', start: '2026-11-15', end: '2026-11-19', baseStart: '2026-11-15', baseEnd: '2026-11-19', status: 'Not Started', prio: 'Low', comments: '' },
      { id: id('d'), name: 'Day-of logistics plan', assigned: 'Devon M.', start: '2026-11-17', end: '2026-11-19', baseStart: '2026-11-17', baseEnd: '2026-11-19', status: 'Not Started', prio: 'Medium', comments: '' },
    ],
  };
}
...
function createPersonalGoals() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Course modules 1-5', assigned: 'Me', start: '2026-09-01', end: '2026-09-12', baseStart: '2026-09-01', baseEnd: '2026-09-12', status: 'Complete', prio: 'High', comments: 'Finished a day early.' },
      { id: id('d'), name: 'Course modules 6-10', assigned: 'Me', start: '2026-09-13', end: '2026-09-20', baseStart: '2026-09-13', baseEnd: '2026-09-20', status: 'In Progress', prio: 'High', comments: 'Networking module is dense — budget extra time.' },
      { id: id('d'), name: 'Practice exam', assigned: 'Me', start: '2026-09-21', end: '2026-09-21', baseStart: '2026-09-21', baseEnd: '2026-09-21', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'Certification exam', assigned: 'Me', start: '2026-09-22', end: '2026-09-22', baseStart: '2026-09-22', baseEnd: '2026-09-22', status: 'Not Started', prio: 'High', comments: 'Book the testing slot.' },
      { id: id('d'), name: 'Base mileage build-up', assigned: 'Me', start: '2026-09-01', end: '2026-09-19', baseStart: '2026-09-01', baseEnd: '2026-09-19', status: 'In Progress', prio: 'Medium', comments: 'On pace for 8k long run.' },
      { id: id('d'), name: 'Race day (10k)', assigned: 'Me', start: '2026-09-27', end: '2026-09-27', baseStart: '2026-09-27', baseEnd: '2026-09-27', status: 'Not Started', prio: 'High', comments: 'Signed up — bib #4021.' },
    ],
  };
}
...
function createLLMFeatureLaunch() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Quality bar & golden eval set', assigned: 'Nadia R.', start: '2026-09-14', end: '2026-09-18', baseStart: '2026-09-14', baseEnd: '2026-09-18', status: 'Complete', prio: 'High', comments: '250 labelled examples, signed off by product.' },
      { id: id('d'), name: 'Automated eval harness', assigned: 'Tom B.', start: '2026-09-16', end: '2026-09-25', baseStart: '2026-09-16', baseEnd: '2026-09-25', status: 'In Progress', prio: 'High', comments: 'Runs on every prompt change in CI.' },
      { id: id('d'), name: 'Prompt iteration on failures', assigned: 'Nadia R.', start: '2026-09-18', end: '2026-09-30', baseStart: '2026-09-18', baseEnd: '2026-09-30', status: 'In Progress', prio: 'High', comments: 'Refusal rate down from 9% to 3%.' },
      { id: id('d'), name: 'Guardrails & refusal handling', assigned: 'Priya S.', start: '2026-09-21', end: '2026-09-30', baseStart: '2026-09-16', baseEnd: '2026-09-25', status: 'In Progress', prio: 'High', comments: '' },
      { id: id('d'), name: 'Latency & cost benchmarking', assigned: 'Tom B.', start: '2026-09-24', end: '2026-09-30', baseStart: '2026-09-24', baseEnd: '2026-09-30', status: 'Not Started', prio: 'Medium', comments: 'Need a decision on caching strategy.' },
      { id: id('d'), name: 'Dogfood feedback triage', assigned: 'Marcus L.', start: '2026-09-28', end: '2026-10-07', baseStart: '2026-09-28', baseEnd: '2026-10-07', status: 'Not Started', prio: 'Medium', comments: '' },
...
function createRagAssistant() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Source inventory & access', assigned: 'Dev A.', start: '2026-10-05', end: '2026-10-07', baseStart: '2026-10-05', baseEnd: '2026-10-07', status: 'Complete', prio: 'High', comments: '9 sources, 4.2k pages total.' },
      { id: id('d'), name: 'Ingestion & chunking pipeline', assigned: 'Dev A.', start: '2026-10-07', end: '2026-10-14', baseStart: '2026-10-07', baseEnd: '2026-10-14', status: 'Complete', prio: 'High', comments: 'Semantic chunking beat fixed-size.' },
      { id: id('d'), name: 'Vector store setup', assigned: 'Ravi M.', start: '2026-10-09', end: '2026-10-14', baseStart: '2026-10-09', baseEnd: '2026-10-14', status: 'Complete', prio: 'High', comments: '' },
      { id: id('d'), name: 'Retrieval eval set', assigned: 'Sara K.', start: '2026-10-12', end: '2026-10-16', baseStart: '2026-10-08', baseEnd: '2026-10-12', status: 'In Progress', prio: 'High', comments: '140 of 200 questions written.' },
      { id: id('d'), name: 'Reranking experiments', assigned: 'Ravi M.', start: '2026-10-16', end: '2026-10-23', baseStart: '2026-10-16', baseEnd: '2026-10-23', status: 'In Progress', prio: 'Medium', comments: 'Recall@5 up from 71% to 88%.' },
      { id: id('d'), name: 'Stale content cleanup', assigned: 'Sara K.', start: '2026-10-14', end: '2026-10-20', baseStart: '2026-10-06', baseEnd: '2026-10-12', status: 'Overdue', prio: 'High', comments: 'Blocked — needs doc owners to confirm.' },
      { id: id('d'), name: 'Citation & grounding checks', assigned: 'Dev A.', start: '2026-10-21', end: '2026-10-28', baseStart: '2026-10-21', baseEnd: '2026-10-28', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Hallucination review pass', assigned: 'Sara K.', start: '2026-10-26', end: '2026-10-30', baseStart: '2026-10-26', baseEnd: '2026-10-30', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Pilot onboarding & training', assigned: 'Support Lead', start: '2026-11-02', end: '2026-11-06', baseStart: '2026-11-02', baseEnd: '2026-11-06', status: 'Not Started', prio: 'Medium', comments: '' },
    ],
  };
}
...
function createMLModelDevelopment() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Training dataset assembly', assigned: 'Iris P.', start: '2026-10-26', end: '2026-10-30', baseStart: '2026-10-26', baseEnd: '2026-10-30', status: 'Complete', prio: 'High', comments: '3 years of history, 1.1M rows.' },
      { id: id('d'), name: 'Feature engineering', assigned: 'Iris P.', start: '2026-10-29', end: '2026-11-06', baseStart: '2026-10-26', baseEnd: '2026-11-03', status: 'In Progress', prio: 'High', comments: 'Dropped 2 leaky features.' },
      { id: id('d'), name: 'Leakage & data quality audit', assigned: 'Ben O.', start: '2026-11-02', end: '2026-11-06', baseStart: '2026-11-02', baseEnd: '2026-11-06', status: 'In Progress', prio: 'High', comments: '' },
      { id: id('d'), name: 'Baseline model training', assigned: 'Iris P.', start: '2026-11-04', end: '2026-11-12', baseStart: '2026-11-04', baseEnd: '2026-11-12', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Hyperparameter tuning', assigned: 'Ben O.', start: '2026-11-09', end: '2026-11-16', baseStart: '2026-11-09', baseEnd: '2026-11-16', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'Bias & fairness evaluation', assigned: 'Ana T.', start: '2026-11-12', end: '2026-11-18', baseStart: '2026-11-06', baseEnd: '2026-11-12', status: 'Not Started', prio: 'High', comments: 'Release gate.' },
...
function createAgentAutomationPilot() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'Tier-1 workflow mapping', assigned: 'Omar D.', start: '2026-10-01', end: '2026-10-03', baseStart: '2026-10-01', baseEnd: '2026-10-03', status: 'Complete', prio: 'High', comments: '6 ticket categories in scope.' },
      { id: id('d'), name: 'Helpdesk + CRM integrations', assigned: 'Lena F.', start: '2026-10-05', end: '2026-10-09', baseStart: '2026-10-05', baseEnd: '2026-10-09', status: 'Complete', prio: 'High', comments: 'Read-only scopes for the pilot.' },
      { id: id('d'), name: 'Agent scaffolding & tools', assigned: 'Lena F.', start: '2026-10-07', end: '2026-10-13', baseStart: '2026-10-03', baseEnd: '2026-10-09', status: 'In Progress', prio: 'High', comments: '' },
      { id: id('d'), name: 'Escalation & guardrail rules', assigned: 'Omar D.', start: '2026-10-07', end: '2026-10-13', baseStart: '2026-10-07', baseEnd: '2026-10-13', status: 'In Progress', prio: 'High', comments: 'Auto-escalate on refunds and outages.' },
      { id: id('d'), name: 'Sandbox eval on past tickets', assigned: 'Lena F.', start: '2026-10-12', end: '2026-10-16', baseStart: '2026-10-12', baseEnd: '2026-10-16', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Human review UI', assigned: 'Jae W.', start: '2026-10-12', end: '2026-10-18', baseStart: '2026-10-12', baseEnd: '2026-10-18', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Pilot with 2 support agents', assigned: 'Support Lead', start: '2026-10-19', end: '2026-10-28', baseStart: '2026-10-19', baseEnd: '2026-10-28', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Deflection measurement', assigned: 'Omar D.', start: '2026-10-26', end: '2026-10-30', baseStart: '2026-10-26', baseEnd: '2026-10-30', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'Cost per ticket analysis', assigned: 'Jae W.', start: '2026-10-26', end: '2026-10-30', baseStart: '2026-10-26', baseEnd: '2026-10-30', status: 'Not Started', prio: 'Medium', comments: 'Needs a decision on how to price tokens.' },
    ],
  };
}
...
function createAIGovernance() {
  return {
    ...
    dashTasks: [
      { id: id('d'), name: 'AI system discovery', assigned: 'Hannah G.', start: '2026-11-02', end: '2026-11-13', baseStart: '2026-10-26', baseEnd: '2026-11-06', status: 'In Progress', prio: 'High', comments: '19 found so far, 7 previously unregistered.' },
      { id: id('d'), name: 'Model inventory register', assigned: 'Hannah G.', start: '2026-11-09', end: '2026-11-16', baseStart: '2026-11-09', baseEnd: '2026-11-16', status: 'In Progress', prio: 'High', comments: '' },
      { id: id('d'), name: 'Risk tiering framework', assigned: 'Legal', start: '2026-11-11', end: '2026-11-20', baseStart: '2026-11-11', baseEnd: '2026-11-20', status: 'In Progress', prio: 'High', comments: 'Mapping to EU AI Act categories.' },
      { id: id('d'), name: 'Acceptable-use policy draft', assigned: 'Legal', start: '2026-11-16', end: '2026-11-25', baseStart: '2026-11-16', baseEnd: '2026-11-25', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'DPIA / data protection review', assigned: 'Security', start: '2026-11-16', end: '2026-11-27', baseStart: '2026-11-05', baseEnd: '2026-11-16', status: 'On Hold', prio: 'High', comments: 'Waiting on the finalised inventory.' },
      { id: id('d'), name: 'Vendor model assessments', assigned: 'Security', start: '2026-11-18', end: '2026-11-30', baseStart: '2026-11-18', baseEnd: '2026-11-30', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'Bias testing standard', assigned: 'Ana T.', start: '2026-11-20', end: '2026-12-02', baseStart: '2026-11-20', baseEnd: '2026-12-02', status: 'Not Started', prio: 'Medium', comments: '' },
      { id: id('d'), name: 'AI incident response playbook', assigned: 'Hannah G.', start: '2026-11-25', end: '2026-12-05', baseStart: '2026-11-25', baseEnd: '2026-12-05', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'SDLC review gate rollout', assigned: 'ML Lead', start: '2026-11-25', end: '2026-12-04', baseStart: '2026-11-25', baseEnd: '2026-12-04', status: 'Not Started', prio: 'High', comments: '' },
      { id: id('d'), name: 'Audit evidence pack', assigned: 'Hannah G.', start: '2026-12-04', end: '2026-12-11', baseStart: '2026-12-04', baseEnd: '2026-12-11', status: 'Not Started', prio: 'Medium', comments: '' },
    ],
  };
}
